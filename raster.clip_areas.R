####################################################################################################
#                                                                                                  #
#         raster.clip_areas.R - Raster masking, cropping or reformating from command line          #
#                                                                                                  #
#                                                                                                  #
...
####################################################################################################
#
# Version:      0.1.2 (2019-05-08)
# R version:    3.6.0 (2019-04-26) -- "Planting of a Tree"
#
# Usage:        Rscript --vanilla raster.clip_areas.R <path to config.yml file>
# 
